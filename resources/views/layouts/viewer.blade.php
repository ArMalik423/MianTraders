...
<head>
    ...
    <link rel="icon" href="{{asset('backend_view/assets/images/ht_logo.png')}}" type="image/icon type">
    <title>Hussnain Traders</title>
</head>

<body>
<div class="wrapper">
    @include('layouts._partials._header')
    @include('layouts._partials._viewer_sidebar')
    @yield('content')
</div>
